    ...
    <div class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <header class="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-10 py-5 glass-effect">
            ...
            <div class="flex gap-3 items-center">
                <span class="text-sm font-medium text-slate-600 dark:text-slate-400 self-center hidden sm:block">Already have an account?</span>
        ...
        <main class="flex-1 flex justify-center pt-32 pb-16 px-4 sm:px-6">
            <div class="w-full max-w-[520px] flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-3 text-center">
                    ...
                    <p class="text-slate-600 dark:text-slate-400 text-lg font-medium">Create your account and start exploring amazing stays</p>
                </div>
                
                <!-- Sign Up Form with glass effect -->
                <div class="glass-effect rounded-2xl p-8 shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
                    <form action="../public/register.php" method="post" class="flex flex-col gap-5">
                        <label class="flex flex-col gap-2.5 group">
                            ...
                            <div class="relative">
                                ...
                                <span class="absolute right-4 top-1/2 -translate-y-1/2 text-primary material-symbols-outlined text-xl pointer-events-none">expand_more</span>
                            </div>
                        </label>
