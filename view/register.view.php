...
<body
    class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-indigo-950 dark:to-slate-900 font-display text-slate-900 dark:text-white antialiased animate-gradient">
    <div class="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">

        <header
            class="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-10 py-5 glass-effect">
            <div class="flex items-center gap-3">
                <div class="size-10 text-primary transform hover:scale-110 transition-transform duration-300">
                    <svg class="w-full h-full drop-shadow-lg" fill="none" viewbox="0 0 48 48"
            ...
            <div class="flex gap-3 items-center">
                <span class="text-sm font-medium text-slate-600 dark:text-slate-400 self-center hidden sm:block">Already
                    have an account?</span>
                <a href="/view/login.view.php"
        ...
        <main class="flex-1 flex justify-center pt-32 pb-16 px-4 sm:px-6">
            <div class="w-full max-w-[520px] flex flex-col gap-8">

                <div class="flex flex-col gap-3 text-center">
                    <h1
                        class="text-slate-900 dark:text-white text-4xl sm:text-5xl font-black leading-tight tracking-tight bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
                        Start Kari
                    </h1>
                    <p class="text-slate-600 dark:text-slate-400 text-lg font-medium">Create your account and start
                        exploring amazing stays</p>
                </div>


                <div
                    class="glass-effect rounded-2xl p-8 shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
                    <form action="../controllers/register.php" method="post" class="flex flex-col gap-5">
                        <label class="flex flex-col gap-2.5 group">
                            <span
                                class="text-slate-700 dark:text-slate-200 text-sm font-semibold flex items-center gap-2">
                                <span class="material-symbols-outlined text-primary text-lg">person</span>
                                I want to join as
                            </span>
                            <div class="relative">
                                <select name="role"
                                    class="input-glow form-select w-full rounded-xl border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/80 text-slate-900 dark:text-white h-14 px-4 text-base focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all appearance-none font-medium">
                                    <option value="">Select your role</option>
                                    <option value="traveler"> Traveler</option>
                                    <option value="host"> Host</option>
                                </select>
                                <span
                                    class="absolute right-4 top-1/2 -translate-y-1/2 text-primary material-symbols-outlined text-xl pointer-events-none">expand_more</span>
                            </div>
                        </label>

                        <div class="flex flex-col sm:flex-row gap-4">
                            <label class="flex flex-col flex-1 gap-2.5 group">
                                <span class="text-slate-700 dark:text-slate-200 text-sm font-semibold">First Name</span>
                        ...
                        <button
                            ...
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity">
                            </div>
                        </button>

                        <div class="relative flex items-center py-4">
                            <div class="flex-grow border-t border-slate-300 dark:border-slate-700"></div>
                            <span class="flex-shrink-0 mx-4 text-slate-500 dark:text-slate-400 text-sm font-medium">Or
                                continue with</span>
                            <div class="flex-grow border-t border-slate-300 dark:border-slate-700"></div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button
                                ...
                                type="button">
                                <svg class="size-5 group-hover:scale-110 transition-transform" fill="none"
                                    viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M23.766 12.2764C23.766 11.4607 23.6999 10.6406 23.5588 9.83807H12.24V14.4591H18.7217C18.4528 15.9494 17.5885 17.2678 16.323 18.1056V21.1039H20.19C22.4608 19.0139 23.766 15.9274 23.766 12.2764Z"
                                        fill="#4285F4"></path>
                                    <path
                                        d="M12.24 24.0008C15.4765 24.0008 18.2059 22.9382 20.1945 21.1039L16.3275 18.1055C15.2517 18.8375 13.8627 19.252 12.2445 19.252C9.11388 19.252 6.45946 17.1399 5.50705 14.2819H1.46997V17.4107C3.48665 21.4194 7.62946 24.0008 12.24 24.0008Z"
                                        fill="#34A853"></path>
                                    <path
                                        d="M5.50253 14.2818C5.00397 12.8099 5.00397 11.1961 5.50253 9.7242V6.5954H1.46997C-0.171747 9.84624 -0.171747 14.1657 1.46997 17.4107L5.50253 14.2818Z"
                                        fill="#FBBC05"></path>
                                    <path
                                        d="M12.24 4.74966C13.9509 4.7232 15.6044 5.36697 16.8434 6.54867L20.2695 3.12262C18.1001 1.0855 15.2208 -0.034466 12.24 0.000808666C7.62946 0.000808666 3.48665 2.58222 1.46997 6.5954L5.50705 9.7242C6.45502 6.86169 9.10937 4.74966 12.24 4.74966Z"
                                        fill="#EA4335"></path>
                                </svg>
                                Google
                            </button>
