...
include __DIR__ . "/../src/traveler.php";
...
$reviews = $review->getReviewsByRentalId($_GET['rental_id']);
...
<body
    ...
    <main class="max-w-[1160px] mx-auto px-4 sm:px-10 py-6 pb-20">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div
                    ...
                    <span class="flex items-center gap-1">
                        ...
                        <span><?= $rental_details->getAverageRating() ?></span>
                    </span>
                    <span class="text-deep-navy dark:text-gray-400">·</span>
                    <a class="underline decoration-1 underline-offset-2" href="#reviews"><?= $rental_details->getReviewCount() ?> reviews</a>
                    <span class="text-deep-navy dark:text-gray-400">·</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
                    ...
                    <div class="flex justify-between items-end mb-6">
                        ...
                        <div class="flex items-center gap-1 text-sm font-medium">
                            <span class="material-symbols-outlined text-slate-blue text-[16px]"
                                style="font-variation-settings: 'FILL' 1;">star</span>
                            <span class="text-deep-navy dark:text-gray-300"><?= $rental_details->getAverageRating() ?></span>
                            <span class="text-gray-400">·</span>
                            <span class="text-gray-500 underline"><?= $rental_details->getReviewCount() ?> reviews</span>
                        </div>
                    </div>
                    <div class="border border-gray-400 rounded-lg overflow-hidden mb-4 bg-white dark:bg-gray-900">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input type="number" name="nightnumber"
            ...
            <div class="lg:col-span-2 flex flex-col gap-8">
                <form method="post" action="../controllers/add_review.php" ;
                    class="bg-cream dark:bg-background-dark border border-cream-border dark:border-gray-700 rounded-xl shadow-[0_6px_16px_rgba(0,0,0,0.12)] p-6">
                    <h2 class="text-2xl font-bold mb-6 text-deep-navy">Leave a Review</h2>
                    <input type="hidden" name="rental_id" value="<?= $rental_details->getId() ?>" />
                    <label class="block text-sm font-medium mb-2 text-deep-navy dark:text-gray-200"
                            for="star">Rating <span class="material-symbols-outlined text-slate-blue text-2xl">star</span></label>
                    <select class="mb-4 w-full border border-gray-400 rounded-lg p-3 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-slate-400"
                     name="rating" id="star">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            class="w-full border border-gray-400 rounded-lg p-3 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-slate-400"
                            id="review" name="comment" rows="4" placeholder="Write your review here..."></textarea>
                    </div>
                    <button
                        class="w-full bg-deep-navy hover:opacity-90 text-white font-bold py-3.5 rounded-lg text-lg transition-all mb-4 shadow-sm">
                        Submit Review
                ...
                <div class="border-b border-cream-border dark:border-gray-800 pb-8" id="reviews">
                    <div class="flex items-center gap-2 mb-8">
                        <span class="material-symbols-outlined text-slate-blue text-2xl"
                            style="font-variation-settings: 'FILL' 1;">star</span>
                        <h2 class="text-2xl font-bold text-deep-navy"><?= $rental_details->getAverageRating() ?> · <?= $rental_details->getReviewCount() ?> reviews</h2>
                    </div>
                            ...
                            <div>
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <?php 
                                        ...
                                        $user_details = $traveler->getById($rev->getUserId());
                                    ?>
                                    <div>
                                        <h4 class="font-bold text-base text-deep-navy dark:text-white"><?= $user_details->getFullName() ?> - <?= $rev->getRating() ?> <span class="material-symbols-outlined text-slate-blue">star</span></h4>
                                        <p class="text-sm text-gray-500"><?= $rev->getCreatedAt() ?></p>
                                    </div>
                                </div>
                                <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                                    <?= $rev->getComment(); ?>
